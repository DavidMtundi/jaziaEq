...
class BodyWidget extends StatelessWidget {
  ...
  int? wig_price;
   ...
   BodyWidget({
    Key? key,
    this.wig_des, this.wig_name, this.wig_price, this.wig_url
...
//                                                ColorFilter.mode(Colors.red, BlendMode.colorBurn)
                           ...
                           onTap: ()=> showDialog(context: context, barrierDismissible: true, builder: (context)=> GetImage(wig_url: wig_url!,)),
                        ),
                      ),
                      Padding(
                      ...
                      Expanded(
                        ...
                        child: GestureDetector(
                          ...
                          onTap: ()=> showDialog(context: context, barrierDismissible: true, builder: (context)=> GetName(wig_name: wig_name!,)),
