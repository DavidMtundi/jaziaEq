...
class RegisterNewForm extends StatefulWidget {
  const RegisterNewForm({Key? key}) : super(key: key);

  @override
  _RegisterNewFormState createState() => _RegisterNewFormState();
}

class _RegisterNewFormState extends State<RegisterNewForm> {
                              ...
                              const SizedBox(height: 15),
                               TextField(
                                ...
                                decoration: InputDecoration.collapsed(
                                  ...
                                  hintStyle: _style.copyWith(fontSize: 12),
                                ),
                              ),
                              const SizedBox(height: 15),
                              TextFormField(
